...
HTML – Structuring the web pages and semantic content.

CSS – Custom styling for layout, colors, and visual design.

Bootstrap – Responsive components and a mobile-friendly layout.

JavaScript – Interactive elements and basic dynamic behavior.
